    ...
    <>
      ...
      >
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div 
              className="fixed inset-0 bg-black bg-opacity-90 backdrop-blur-sm flex flex-col items-center justify-center space-y-8 z-40"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
      ...
      {/* This empty div acts as a spacer to prevent content from being hidden behind the navbar */}
